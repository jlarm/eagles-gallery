...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::post('/manage/tournaments/{tournament}/publish', [TournamentController::class, 'publish'])->name('tournaments.publish');
    Route::post('/manage/tournaments/{tournament}/unpublish', [TournamentController::class, 'unpublish'])->name('tournaments.unpublish');
    ...
    Route::post('/manage/albums/{album}/publish', [AlbumController::class, 'publish'])->name('albums.publish');
    Route::post('/manage/albums/{album}/unpublish', [AlbumController::class, 'unpublish'])->name('albums.unpublish');
