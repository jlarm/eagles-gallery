...
/**
* @see \App\Http\Controllers\PhotoController::setCover
* @see app/Http/Controllers/PhotoController.php:39
* @route '/albums/{album}/photos/{photo}/cover'
*/
export const setCover = (args: { album: number | { id: number }, photo: number | { id: number } } | [album: number | { id: number }, photo: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: setCover.url(args, options),
    method: 'post',
})
...
* @route '/albums/{album}/photos/{photo}/cover'
*/
setCover.url = (args: { album: number | { id: number }, photo: number | { id: number } } | [album: number | { id: number }, photo: number | { id: number } ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
            album: args[0],
            photo: args[1],
    ...
    return setCover.definition.url
            .replace('{album}', parsedArgs.album.toString())
...
* @route '/albums/{album}/photos/{photo}/cover'
*/
setCover.post = (args: { album: number | { id: number }, photo: number | { id: number } } | [album: number | { id: number }, photo: number | { id: number } ], options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: setCover.url(args, options),
    method: 'post',
})
...
* @route '/albums/{album}/photos/{photo}/cover'
*/
const setCoverForm = (args: { album: number | { id: number }, photo: number | { id: number } } | [album: number | { id: number }, photo: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: setCover.url(args, options),
    method: 'post',
})
...
* @route '/albums/{album}/photos/{photo}/cover'
*/
setCoverForm.post = (args: { album: number | { id: number }, photo: number | { id: number } } | [album: number | { id: number }, photo: number | { id: number } ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: setCover.url(args, options),
    method: 'post',
})

setCover.form = setCoverForm
...
const PhotoController = { presign, reorder, store, setCover, destroy, download }
